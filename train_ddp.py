...
from new_data_utils_ddp import build_happy_dataset_for_train, build_fiq_dataset_for_train, build_fiq_dataset_for_val, build_happy_dataset_for_val
import psutil
...
if __name__ == "__main__":
    ...
    if args.dataset.startswith("fiq"):
        ...
        train_dataset, train_sampler, train_loader= build_fiq_dataset_for_train(dataset_name=args.dataset)
    ...
    # elif args.dataset in ["circo"]:
        ...
        train_dataset, train_sampler, train_loader = build_happy_dataset_for_train(dataset_name=args.dataset)
